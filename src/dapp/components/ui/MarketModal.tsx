...
import sunflower from "../../images/ore/stone/fruit.png";
      ...
      <Panel>
        <div id="welcome">
          <h1 className="price-header">
            Supply is growing!
            <img src={alert} className="price-alert" alt="" />
          </h1>
            ...
            <>
              <div>
                ...
                <div className="current-price-container ">
                  <img className="sunflower-price" src={sunflower} alt="" />
                  <span className="current-price">= {currentPrice} $PIMI</span>
                </div>
              </div>
              ...
              {nextHalvingThreshold && (
                <div>
                  ...
                  <div className="current-price-container ">
                    <img className="sunflower-price" src={sunflower} alt="" />
                    <span className="current-price">= {nextPrice} $PIMI</span>
                  </div>
                </div>
              )}
