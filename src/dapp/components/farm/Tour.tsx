...
const steps: ReactourStep[] = [
	{
		selector: '#first-stone',
		content: 'This stone is ready for harvest. Click on the stone.',
	},
	{
		selector: '#balance',
		content: ({ goTo }) => (
			<div>
				You received $$$ Pixel Mine Tokens for the harvest
				<br />
				<div id="tour-button">
	...
	{
		selector: '#first-stone',
		content: 'Now you can mine a new ore',
	},
	{
	...
	},
	{
		...
		content: () => (
			<div>
				You can buy different types of ores here. Some are more
